...
from tqsdk import TqSim, TqApi, TqAuth, TqBacktest, TargetPosTask, BacktestFinished
...
try:
    ...
    api = TqApi(backtest=TqBacktest(start_dt=date(2018, 6, 1), end_dt=date(2018, 6, 2)), auth=TqAuth("ggmmh", "gmh339714"))
    # 获得 m1901 5分钟K线的引用
